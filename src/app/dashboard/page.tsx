    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-950">
      ...
      <aside className="w-64 bg-white dark:bg-gray-800 shadow-lg p-4 space-y-4">
        ...
        <nav className="space-y-2">
          <Link
            href={"/dashboard"}
            className={`block w-full text-left p-2 rounded hover:bg-gray-200 bg-gray-200 dark:bg-gray-400`}
          >
            Dashboard
          </Link>
          <Link
            href={"/dashboard/new"}
            className={`block w-full text-left p-2 rounded hover:bg-gray-200 dark:hover:bg-gray-400`}
          >
            New
          </Link>
          <Link
