    ...
    <div className=" mx-auto bg-white space-y-6 ">
      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            name="collegeName"
            placeholder="Government Girls Polytechnic Gorakhpur"
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors hover:border-blue-500 overflow-hidden">
              {previewImage ? (
                <>
                  <img
                    src={previewImage}
