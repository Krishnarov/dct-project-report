  ...
  return (
    <div className=" mx-auto bg-white ">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-500">Provide information about your project</p>
      </div>
      ...
      <div className="space-y-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <input
              name="projectTitle"
              placeholder="Web-based hotel booking system"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all appearance-none bg-[url('data:image/svg+xml;base64,')] bg-no-repeat bg-[center_right_1rem]"
              required
            >
              <option value="">Select Training Type</option>
              <option value="Summer Training Online">Summer Training Online</option>
              <option value="Summer Training Offline">Summer Training Offline</option>
              <option value="Winter Training Online">Winter Training Online</option>
              <option value="Winter Training Offline">Winter Training Offline</option>
            </select>
          </div>
